...
<head>
    ...
    <title>إعادة تعيين كلمة المرور - Tulip Store</title>
...
<body>
        ...
        <div class="auth-card-wrap">
            ...
            <div class="auth-card">
                ...
                <div class="success-message" id="successMsg">
                    <i class="fa fa-check-circle"></i> تم تغيير كلمة المرور بنجاح!
                </div>
                <form onsubmit="event.preventDefault();handleResetPassword();" id="resetForm">
                    <div>
                        <label for="newPass">كلمة المرور الجديدة</label>
                        <div class="control">
                            <input id="newPass" type="password" placeholder="أدخل كلمة السر الجديدة" required>
                            <span class="toggle" data-target="newPass"><i class="fa fa-eye"></i></span>
                        </div>
                    </div>
                    <div>
                        <label for="confirmPass">تأكيد كلمة المرور</label>
                        <div class="control">
                            <input id="confirmPass" type="password" placeholder="أعد كتابة كلمة السر" required>
                            <span class="toggle" data-target="confirmPass"><i class="fa fa-eye"></i></span>
                        </div>
                    </div>
                    ...
                    <button class="action-btn" type="submit" id="submitBtn" disabled>تأكيد</button>
                </form>
            </div>
        </div>
    </div>
    <script>
        ...
        document.getElementById('newPass').addEventListener('input', validatePasswords);
        document.getElementById('confirmPass').addEventListener('input', validatePasswords);
    </script>
</body>
</html>
<?php /**PATH D:\Tulip-Store\resources\views/pages/ar-reset-password.blade.php ENDPATH**/ ?>