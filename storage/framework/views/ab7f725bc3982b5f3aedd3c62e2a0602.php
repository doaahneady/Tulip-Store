    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="p-4 bg-green-50 rounded-xl text-center">
                <p class="text-2xl font-bold text-green-600"><?php echo e($metrics['present_today'] ?? 0); ?></p>
                <p class="text-xs text-gray-500">حاضر</p>
            </div>
            <div class="p-4 bg-red-50 rounded-xl text-center">
                <p class="text-2xl font-bold text-red-600"><?php echo e($metrics['absent_today'] ?? 0); ?></p>
                <p class="text-xs text-gray-500">غائب</p>
            </div>
            <div class="p-4 bg-yellow-50 rounded-xl text-center">
                <p class="text-2xl font-bold text-yellow-600"><?php echo e($metrics['late_today'] ?? 0); ?></p>
                <p class="text-xs text-gray-500">متأخر</p>
            </div>
            <div class="p-4 bg-blue-50 rounded-xl text-center">
                <p class="text-2xl font-bold text-blue-600"><?php echo e($metrics['on_leave_today'] ?? 0); ?></p>
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/dashboards/hr/index.blade.php ENDPATH**/ ?>