...
<body class="db-next">
                ...
                <div class="db4-nav-section">
                    ...
                    <?php if(! $isTraderSession && $canAccess('dashboard.supervisor.index')): ?>
                        <a href="<?php echo e(route('dashboard.supervisor.index')); ?>" class="db4-nav-link <?php echo e(request()->routeIs('dashboard.supervisor.*') ? 'is-active' : ''); ?>">
                            ...
                            <span class="db4-nav-meta">
                                <span class="db4-nav-label"><?php echo e($dashboardLocale === 'ar' ? 'اللوجستيات' : 'Logistics'); ?></span>
                                <span class="db4-nav-hint"><?php echo e($dashboardLocale === 'ar' ? 'تتبع وتوزيع الطلبات' : 'Live tracking and dispatch'); ?></span>
                            </span>
                        </a>
                    <?php endif; ?>

                    <?php if(! $isTraderSession && $canAccess('dashboard.driver.index')): ?>
                        <a href="<?php echo e(route('dashboard.driver.index')); ?>" class="db4-nav-link <?php echo e(request()->routeIs('dashboard.driver.*') ? 'is-active' : ''); ?>">
                            <span class="db4-nav-icon" aria-hidden="true"><i class="fas fa-truck-fast"></i></span>
                            <span class="db4-nav-meta">
                                <span class="db4-nav-label"><?php echo e($dashboardLocale === 'ar' ? 'السائق' : 'Driver'); ?></span>
                                <span class="db4-nav-hint"><?php echo e($dashboardLocale === 'ar' ? 'طلباتي وحالة التوصيل' : 'My deliveries and status'); ?></span>
                            </span>
                        </a>
                    <?php endif; ?>
    ...
    <?php if($dashKey): ?>
        <script>
            window.DASHBOARD_KEY = <?php echo json_encode($dashKey, 15, 512) ?>;
            window.DASHBOARD_PERMISSIONS = <?php echo json_encode($resolvedPerm, 15, 512) ?>;
