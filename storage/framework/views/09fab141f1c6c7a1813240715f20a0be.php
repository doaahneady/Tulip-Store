...
<body>
    ...
    <script>
        ...
        const CUSTOMER_BALANCE = <?php echo e(Auth::check() ? (float) (Auth::user()->balance ?? 0) : 'null'); ?>;
        const IS_AUTHENTICATED = <?php echo e(Auth::check() ? 'true' : 'false'); ?>;
        const USER_CURRENCY = '<?php echo e(Auth::check() ? (Auth::user()->currency ?? "USD") : "USD"); ?>';
...
<?php /**PATH E:\Tulip-Store\resources\views/cart.blade.php ENDPATH**/ ?>