                ...
                <form id="profileForm" onsubmit="saveProfile(event)">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-input" id="email" value="<?php echo e(Auth::user()->email ?? ''); ?>" placeholder="example@email.com">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
...
<?php /**PATH D:\Tulip-Store\resources\views/profile.blade.php ENDPATH**/ ?>