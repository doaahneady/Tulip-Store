            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__currentLoopData = ($employees ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        ?>
                        <td class="px-6 py-4 text-gray-700"><?php if($monthly > 0): ?> <?php echo app(App\Services\CurrencyService::class)->formatUsd((float)($monthly)); ?> <?php elseif($salary > 0): ?> <?php echo app(App\Services\CurrencyService::class)->formatUsd((float)($salary)); ?> <?php else: ?> - <?php endif; ?></td>
                        <td class="px-6 py-4 text-gray-700"><?php if($hourly > 0): ?> <?php echo app(App\Services\CurrencyService::class)->formatUsd((float)($hourly)); ?> <?php else: ?> - <?php endif; ?></td>
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Tulip-Store\resources\views/dashboards/hr/payroll.blade.php ENDPATH**/ ?>