...
<body>
            ...
            <div class="profile-header">
                ...
                <div class="profile-avatar" id="profileAvatar">
                    <img
                        ...
                        src="<?php echo e(Auth::user()->profile_photo ? Storage::url(Auth::user()->profile_photo) : ''); ?>"
                        alt="صورة المستخدم"
                        style="<?php echo e(Auth::user()->profile_photo ? '' : 'display:none;'); ?>"
                    >
                    <i
                    ...
                    <form id="profileForm" onsubmit="saveProfile(event)">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" disabled class="form-input" id="email" value="<?php echo e(Auth::user()->email ?? ''); ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group" style="grid-column:1/-1;">
                                ...
                                <input type="hidden" id="currencyPref" value="<?php echo e(strtoupper((string) (Auth::user()->currency ?? (session('currency') ?? 'SYP')))); ?>">
                    ...
                    <div style="margin-top:1.5rem; padding:1.25rem; border:1px solid #e8e8e8; border-radius:14px; background:linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:1rem; flex-wrap:wrap;">
                            ...
                            <div id="balanceDisplay" style="font-size:1.25rem; font-weight:900; color:#1a1a1a;">
                                <span id="balanceAmount"><?php echo e(number_format((float) (Auth::user()->balance ?? 0), 2)); ?></span>
    ...
    <script>
        ...
        function updateBalanceDisplay(currency) {
            ...
            const balanceSYP = <?php echo e((float) (Auth::user()->balance ?? 0)); ?>;
            const exchangeRate = <?php echo e(config('app.usd_to_syp_rate', 13000)); ?>;
...
<?php /**PATH E:\Tulip-Store\resources\views/profile.blade.php ENDPATH**/ ?>