...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-8">
    <div class="stat-card bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <h3 id="kpiRevenueToday" class="text-xl font-bold text-gray-900 mt-1"><?php echo e(number_format($metrics['revenue_today'] ?? 0, 2)); ?></h3>
    ...
    <div class="stat-card bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <h3 id="kpiActiveOrders" class="text-xl font-bold text-gray-900 mt-1"><?php echo e(number_format($metrics['active_orders'] ?? 0)); ?></h3>
    ...
    <div class="stat-card bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <h3 id="kpiTotalProducts" class="text-xl font-bold text-gray-900 mt-1"><?php echo e(number_format($metrics['total_products'] ?? 0)); ?></h3>
    ...
    <div class="stat-card bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <h3 id="kpiTotalUsers" class="text-xl font-bold text-gray-900 mt-1"><?php echo e(number_format($metrics['total_users'] ?? 0)); ?></h3>
    ...
    <div class="stat-card bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <h3 id="kpiLowStock" class="text-xl font-bold text-gray-900 mt-1"><?php echo e(number_format($metrics['low_stock_alerts'] ?? 0)); ?></h3>
    ...
    <div class="stat-card bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <h3 id="kpiPendingTickets" class="text-xl font-bold text-gray-900 mt-1"><?php echo e(number_format($metrics['pending_support_tickets'] ?? 0)); ?></h3>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="p-4 bg-blue-50 rounded-xl text-center">
                <p class="text-2xl font-bold text-blue-600"><?php echo e(number_format($metrics['user_growth'] ?? 0, 1)); ?>%</p>
                <p class="text-xs text-gray-500">نمو المستخدمين</p>
            </div>
            <div class="p-4 bg-green-50 rounded-xl text-center">
                <p class="text-2xl font-bold text-green-600"><?php echo e(number_format($metrics['revenue_growth'] ?? 0, 1)); ?>%</p>
                <p class="text-xs text-gray-500">نمو الإيرادات</p>
            </div>
            <div class="p-4 bg-orange-50 rounded-xl text-center">
                <p class="text-2xl font-bold text-orange-600"><?php echo e(number_format($metrics['order_growth'] ?? 0, 1)); ?>%</p>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="p-4 bg-red-50 rounded-xl text-center">
                <p class="text-2xl font-bold text-red-600"><?php echo e(number_format($metrics['system_alerts'] ?? 0)); ?></p>
                <p class="text-xs text-gray-500">تنبيهات النظام</p>
            </div>
            <div class="p-4 bg-purple-50 rounded-xl text-center">
                <p class="text-2xl font-bold text-purple-600"><?php echo e(number_format($metrics['avg_order_value'] ?? 0, 2)); ?></p>
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tulip-Store\resources\views/dashboards/super-admin/index.blade.php ENDPATH**/ ?>