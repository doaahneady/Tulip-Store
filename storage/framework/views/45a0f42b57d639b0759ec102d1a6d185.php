...
<div class="mb-6 flex flex-wrap items-center justify-between gap-3">
    <div class="flex flex-wrap items-center gap-2">
        <a href="<?php echo e(route('dashboard.cs.index')); ?>" class="inline-flex items-center gap-2 bg-gray-100 text-gray-700 px-4 py-2 rounded-xl hover:bg-gray-200 transition">
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100">
    <div class="p-6 border-b border-gray-100">
        <form method="GET" action="<?php echo e(route('dashboard.cs.orders')); ?>" class="grid grid-cols-1 md:grid-cols-6 gap-3">
            <input name="search" value="<?php echo e(request('search')); ?>" class="border rounded-lg px-3 py-2 w-full md:col-span-2" placeholder="بحث: رقم الطلب / اسم / هاتف / بريد">
            ...
            <div class="md:col-span-6 flex items-center gap-2">
                ...
                <a href="<?php echo e(route('dashboard.cs.orders')); ?>" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200">إعادة ضبط</a>
            </div>
        </form>
    </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-gray-500"><?php echo e(number_format((int) ($order->items_count ?? 0))); ?> items</div>
                            </td>
                            <td class="px-6 py-4 text-gray-700"><?php echo e($storeName); ?></td>
                            <td class="px-6 py-4 text-gray-700">
                                <div class="font-medium"><?php echo e($customerName); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($order->customer->email ?? ''); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="px-2 py-1 text-xs rounded bg-gray-100 text-gray-700"><?php echo e($order->status ?? '-'); ?></span>
                                <?php if(($order->status ?? null) === 'delivered'): ?>
                                    <form method="POST" action="<?php echo e(route('dashboard.cs.orders.change-status', $order)); ?>" class="mt-2">
                                        <?php echo csrf_field(); ?>
                            ...
                            <td class="px-6 py-4">
                                <a href="<?php echo e(route('dashboard.cs.orders.show', $order)); ?>" class="px-3 py-1.5 rounded-lg bg-white border border-gray-200 text-sm text-gray-700 hover:bg-gray-100">عرض</a>
                            </td>
                        </tr>
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/dashboards/cs/orders.blade.php ENDPATH**/ ?>