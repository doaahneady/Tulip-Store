    ...
    <div class="container-custom" style="padding:3rem 1.5rem;">
        <div style="max-width:900px; margin:0 auto;">
            <div style="text-align:center; margin-bottom:3rem;">
                ...
                <p style="font-size:1rem; color:#666;">آخر تحديث: <?php echo e(date('Y-m-d')); ?></p>
            </div>
...
<?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/pages/privacy.blade.php ENDPATH**/ ?>