                                ...
                                <tr>
                                    <td align="center">
                                        <div class="code-box" style="background: linear-gradient(135deg, #ff6f35 0%, #ff8c5a 100%); border-radius: 20px; padding: 25px 20px; display: inline-block; box-shadow: 0 10px 30px rgba(255, 111, 53, 0.3); max-width: 90%;">
                                            <p class="verification-code" style="color: #ffffff; font-size: 42px; font-weight: 600; letter-spacing: 10px; margin: 0;
...
<?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/emails/verification.blade.php ENDPATH**/ ?>