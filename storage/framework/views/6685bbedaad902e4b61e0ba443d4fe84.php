        ...
        <div class="gift-detail">
            <div class="gift-detail-content">
                ...
                <div class="gift-images">
                    <img src="<?php echo e($gift->main_image); ?>" alt="<?php echo e($gift->name); ?>" class="main-image" loading="eager" width="900" height="500" onerror="this.src='/images/gift-placeholder.svg'">
                </div>
                ...
                <div class="gift-info">
                    ...
                    <div class="gift-price"><?php echo e($gift->formatted_price); ?></div>
                ...
                <div class="related-grid">
                    <?php $__currentLoopData = $relatedGifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedGift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="related-card" onclick="window.location.href='<?php echo e(route('gifts.show', $relatedGift)); ?>'">
                            <img src="<?php echo e($relatedGift->main_image); ?>" alt="<?php echo e($relatedGift->name); ?>" class="related-image" loading="lazy" width="320" height="200" onerror="this.src='/images/gift-placeholder.svg'">
                            <div class="related-content">
                                <div class="related-name"><?php echo e($relatedGift->name); ?></div>
                                <div class="related-price"><?php echo e($relatedGift->formatted_price); ?></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/gifts/show.blade.php ENDPATH**/ ?>