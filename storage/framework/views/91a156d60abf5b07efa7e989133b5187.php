                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span class="px-2 py-1 text-xs rounded <?php echo e($isOut ? 'bg-red-100 text-red-700' : ($product->status === 'active' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700')); ?>">
                                <?php echo e($isOut ? 'out_of_stock' : ($product->status === 'draft' ? 'inactive' : $product->status)); ?>
            ...
            <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="status" class="border rounded-lg px-3 py-2 w-full" required>
                        <?php $currentStatus = $product->status === 'draft' ? 'inactive' : $product->status; ?>
                        <?php $__currentLoopData = ['active','inactive','out_of_stock']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>" <?php if($currentStatus === $status): echo 'selected'; endif; ?>><?php echo e(ucfirst(str_replace('_',' ',$status))); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('dashboards.layouts.app', ['title' => 'Inventory'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Tulip-Store\resources\views/dashboards/vendor/products.blade.php ENDPATH**/ ?>