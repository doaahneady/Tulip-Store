   ...
   <link rel="icon" type="image/png" sizes="48x48" href="/images/fav_icon-v1.png">
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Put map controls under the map on mobile */
            #mapContainer {
                height: auto !important;
                display: flex !important;
                flex-direction: column !important;
            ...
            /* Move "انقر على الخريطة..." card above the map on mobile */
            #mapInstructions{
                position: static !important;
                transform: none !important;
                left: auto !important;
            ...
            #mapBackToCart{ order: -1 !important; }
            #mapSearchWrapper{ order: 0 !important; }
            #map{ order: 1 !important; }
