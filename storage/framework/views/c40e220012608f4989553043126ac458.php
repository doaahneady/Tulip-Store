    ...
    <form method="POST" action="<?php echo e(route('dashboard.admin.mart.products.store')); ?>" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input name="sku" value="<?php echo e(old('sku')); ?>" class="form-input w-full">
            </div>
            <div>
...
<?php echo $__env->make('dashboards.layouts.app', ['title' => 'إضافة منتج', 'subtitle' => 'إضافة منتج جديد لقسم Mart'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tulip-Store\resources\views/dashboards/super-admin/mart-product-create.blade.php ENDPATH**/ ?>