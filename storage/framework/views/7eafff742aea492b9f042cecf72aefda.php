    ...
    <form method="POST" action="<?php echo e(route('dashboard.admin.mart.categories.update', $category)); ?>" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="flex items-center justify-between gap-2 flex-wrap">
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('dashboard.admin.mart')); ?>" class="btn btn-secondary">رجوع</a>
...
<?php echo $__env->make('dashboards.layouts.app', ['title' => 'تعديل تصنيف', 'subtitle' => 'تعديل تصنيف لقسم Mart'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/dashboards/super-admin/mart-category-edit.blade.php ENDPATH**/ ?>