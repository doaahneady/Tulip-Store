                ...
                <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    <div class="flex items-start gap-4">
                        <div class="w-20 h-20 rounded-xl bg-gray-100 overflow-hidden flex items-center justify-center text-gray-400">
                            ...
                            ?>
                            <img src="<?php echo e($coverUrl ?: '/images/gift-placeholder.svg'); ?>" srcset="<?php echo e($p->primary_image_srcset ?? ''); ?>" loading="lazy" class="w-full h-full object-cover" alt="صورة المنتج" onerror="this.onerror=null;this.src='/images/gift-placeholder.svg';">
                        </div>
                        <div class="min-w-0">
                                ...
                                <div class="mt-3 flex flex-wrap items-center gap-2">
                                    <?php $__currentLoopData = array_slice($imgs, 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="w-12 h-12 rounded-lg bg-gray-100 overflow-hidden">
                                            ...
                                            ?>
                                            <img src="<?php echo e($u); ?>" class="w-full h-full object-cover" alt="صورة" onerror="this.onerror=null;this.src='/images/gift-placeholder.svg'">
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(count($imgs) > 6): ?>
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/dashboards/cs/trader-products.blade.php ENDPATH**/ ?>