    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between p-3 bg-blue-800 rounded-xl border border-gray-600">
                ...
                <span class="font-bold text-white"><?php echo e($userActivity['new_registrations']); ?></span>
            </div>
            <div class="flex items-center justify-between p-3 bg-green-800 rounded-xl border border-gray-600">
                ...
                <span class="font-bold text-white"><?php echo e($userActivity['new_this_week']); ?></span>
            </div>
            <div class="flex items-center justify-between p-3 bg-purple-800 rounded-xl border border-gray-600">
                ...
                <span class="font-bold text-white"><?php echo e($userActivity['active_employees']); ?></span>
            </div>
            <div class="flex items-center justify-between p-3 bg-orange-700 rounded-xl border border-gray-600">
                ...
                <span class="font-bold text-white"><?php echo e($userActivity['orders_today']); ?></span>
            </div>
        </div>
    </div>
        ...
        <div class="space-y-4">
            <div class="grid grid-cols-3 gap-3 text-center">
                <div class="p-3 bg-blue-800 rounded-xl border border-gray-600">
                    <p class="text-2xl font-bold text-white"><?php echo e($backupStats['total']); ?></p>
                    <p class="text-xs text-blue-200">الإجمالي</p>
                </div>
                <div class="p-3 bg-green-800 rounded-xl border border-gray-600">
                    <p class="text-2xl font-bold text-white"><?php echo e($backupStats['completed']); ?></p>
                    <p class="text-xs text-green-200">مكتمل</p>
                </div>
                <div class="p-3 bg-red-800 rounded-xl border border-gray-600">
                    <p class="text-2xl font-bold text-white"><?php echo e($backupStats['failed']); ?></p>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm">
        ...
        <div class="grid grid-cols-3 gap-3">
            <div class="p-3 bg-purple-800 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e(number_format($apiStats['avg_response_time'] ?? 0, 0)); ?>ms</p>
            ...
            <div class="p-3 bg-green-800 rounded-xl text-center border border-gray-600">
                ...
                <p class="text-xl font-bold text-white"><?php echo e($success !== null ? (number_format($success, 1).'%') : 'N/A'); ?></p>
                <p class="text-xs text-green-200">نسبة النجاح</p>
            </div>
            <div class="p-3 bg-red-800 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e($metrics['slow_queries_today'] ?? 0); ?></p>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm">
        ...
        <div class="grid grid-cols-3 gap-3">
            <div class="p-3 bg-blue-800 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e($metrics['deployments_this_month'] ?? 0); ?></p>
                <p class="text-xs text-blue-200">نشـر هذا الشهر</p>
            </div>
            <div class="p-3 bg-green-800 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e(isset($metrics['deployment_success_rate']) ? (number_format($metrics['deployment_success_rate'],1).'%') : 'N/A'); ?></p>
                <p class="text-xs text-green-200">معدل النجاح</p>
            </div>
            <div class="p-3 bg-gray-800 rounded-xl text-center border border-gray-600">
                <p class="text-sm font-semibold text-white"><?php echo e(optional($metrics['last_deployment'])->diffForHumans() ?? 'N/A'); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div class="p-4 bg-blue-800 rounded-xl text-center border border-gray-600">
                <p class="text-2xl font-bold text-white"><?php echo e(number_format($logStats['total'])); ?></p>
                <p class="text-xs text-blue-200">إجمالي السجلات</p>
            </div>
            <div class="p-4 bg-green-800 rounded-xl text-center border border-gray-600">
                <p class="text-2xl font-bold text-white"><?php echo e($logStats['today']); ?></p>
                <p class="text-xs text-green-200">سجلات اليوم</p>
            </div>
            <div class="p-4 bg-yellow-600 rounded-xl text-center border border-gray-600">
                <p class="text-2xl font-bold text-white"><?php echo e($logStats['warnings']); ?></p>
                <p class="text-xs text-yellow-100">تحذيرات</p>
            </div>
            <div class="p-4 bg-red-800 rounded-xl text-center border border-gray-600">
                <p class="text-2xl font-bold text-white"><?php echo e($logStats['errors']); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-700">
        ...
        <div class="grid grid-cols-3 gap-3 mb-4">
            <div class="p-3 bg-blue-800 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e($apiStats['total_errors']); ?></p>
                <p class="text-xs text-blue-200">الإجمالي</p>
            </div>
            <div class="p-3 bg-orange-700 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e($apiStats['today_errors']); ?></p>
                <p class="text-xs text-orange-200">اليوم</p>
            </div>
            <div class="p-3 bg-purple-800 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e(number_format($apiStats['avg_response_time'], 0)); ?>ms</p>
                <p class="text-xs text-purple-200">متوسط الاستجابة</p>
            </div>
        </div>
        <div class="space-y-2 max-h-48 overflow-y-auto">
            ...
            <div class="flex items-center justify-between p-2 bg-gray-700 rounded-lg text-sm">
                <span class="text-gray-200"><?php echo e(Str::limit($error->endpoint, 30)); ?></span>
                <span class="px-2 py-1 text-xs rounded bg-red-200 text-red-800"><?php echo e($error->status_code); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-700">
        ...
        <div class="grid grid-cols-3 gap-3 mb-4">
            <div class="p-3 bg-blue-800 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e($queryStats['total']); ?></p>
                <p class="text-xs text-blue-200">الإجمالي</p>
            </div>
            <div class="p-3 bg-yellow-600 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e($queryStats['unoptimized']); ?></p>
                <p class="text-xs text-yellow-100">غير محسّن</p>
            </div>
            <div class="p-3 bg-red-800 rounded-xl text-center border border-gray-600">
                <p class="text-xl font-bold text-white"><?php echo e($queryStats['critical']); ?></p>
        ...
        <div class="space-y-2 max-h-48 overflow-y-auto">
            ...
            <div class="flex items-center justify-between p-2 bg-gray-700 rounded-lg text-sm">
                <span class="text-gray-200"><?php echo e(Str::limit($query->table_name ?? $query->query, 25)); ?></span>
                <div class="flex items-center gap-2">
                    <span class="text-xs text-gray-400"><?php echo e(number_format($query->execution_time, 0)); ?>ms</span>
                    <span class="px-2 py-1 text-xs rounded <?php echo e($query->is_optimized ? 'bg-green-200 text-green-800' : 'bg-yellow-200 text-yellow-800'); ?>">
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/dashboards/it/index.blade.php ENDPATH**/ ?>