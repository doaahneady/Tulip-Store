    ...
    <div class="bg-amber-700 rounded-2xl shadow-sm border border-gray-600 p-4">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-black text-white mt-1"><?php echo e(number_format($metrics['total_orders'] ?? 0)); ?></h3>
            </div>
    ...
    <div class="bg-indigo-800 rounded-2xl shadow-sm border border-gray-600 p-4">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-black text-white mt-1"><?php echo e(number_format($metrics['monthly_orders'] ?? 0)); ?></h3>
            </div>
    ...
    <div class="bg-blue-800 rounded-2xl shadow-sm border border-gray-600 p-4">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-black text-white mt-1"><?php echo e(number_format($metrics['pending_orders'] ?? 0)); ?></h3>
            </div>
    ...
    <div class="bg-emerald-800 rounded-2xl shadow-sm border border-gray-600 p-4">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-black text-white mt-1"><?php echo e(number_format($metrics['completed_orders'] ?? 0)); ?></h3>
            </div>
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Tulip-Store\resources\views/dashboards/vendor/index.blade.php ENDPATH**/ ?>