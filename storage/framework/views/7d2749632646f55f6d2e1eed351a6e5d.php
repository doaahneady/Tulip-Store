...
<div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 mb-4">
    <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <form method="POST" action="<?php echo e(route('dashboard.admin.exchange-rate.update')); ?>" class="flex items-center gap-2">
            <?php echo csrf_field(); ?>
            <input
                type="number"
                ...
                step="0.01"
                min="1"
                value="<?php echo e(\App\Models\SystemSetting::get('usd_to_syp_rate', 117)); ?>"
...
<div class="mb-6 flex flex-wrap items-center justify-between gap-3">
    <div class="flex flex-wrap items-center gap-2">
        ...
        <a href="<?php echo e(route('dashboard.admin.traders')); ?>" class="inline-flex items-center gap-2 bg-amber-700 text-white px-4 py-2 rounded-xl hover:bg-amber-800 transition">
        ...
        <a href="<?php echo e(route('dashboard.admin.activity-logs')); ?>" class="inline-flex items-center gap-2 bg-gray-800 text-white px-4 py-2 rounded-xl hover:bg-black transition">
            <i class="fas fa-clipboard-list"></i>
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Tulip-Store\resources\views/dashboards/super-admin/index.blade.php ENDPATH**/ ?>