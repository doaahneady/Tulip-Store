...
<head>
    ...
    <title><?php echo e($subcategory->name); ?> - توليب مارت</title>
...
<body>
    ...
    <div class="breadcrumb">
        ...
        <a href="<?php echo e(route('mart.category', $category->slug)); ?>"><?php echo e($category->name); ?></a>
        <i class="fas fa-chevron-left"></i>
    ...
    <div class="container">
        <?php if($products->count() > 0): ?>
            ...
            <script>
                ...
                const productIds = <?php echo json_encode($products->pluck('id'), 15, 512) ?>;
            </script>
    ...
    <script>
        ...
        async function loadProducts() {
            try {
                const response = await fetch('/api/products?market=mart&include_attributes=1&subcategory=<?php echo e($subcategory->slug); ?>&category=<?php echo e($category->slug); ?>', {
...
<?php /**PATH E:\Tulip-Store\resources\views/mart/subcategory-products.blade.php ENDPATH**/ ?>