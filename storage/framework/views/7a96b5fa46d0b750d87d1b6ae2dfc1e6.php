            ...
            <div class="content">
                ...
                <form action="<?php echo e(route('trader.register')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="actions">
                        ...
                        <div class="nav">
                            <a href="<?php echo e(route('trader.login.form')); ?>">لدي حساب؟ تسجيل الدخول</a>
                        </div>
                        <div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    apiBtn.addEventListener('click', async () => {
        ...
        const form = document.querySelector('form[action="<?php echo e(route('trader.register')); ?>"]');
        ...
        try {
            ...
            if (json?.success) {
                ...
                window.location = "<?php echo e(route('trader.login.form')); ?>";
            } else {
...
<?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/auth/trader-register.blade.php ENDPATH**/ ?>