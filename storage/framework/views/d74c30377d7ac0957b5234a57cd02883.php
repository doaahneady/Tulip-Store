    ...
    <div class="db4-shell">
        <aside id="sidebar" class="db4-sidebar" aria-label="القائمة">
            <div class="flex items-start justify-between gap-3">
                <a href="<?php echo e(route('dashboard')); ?>" class="db4-brand">
                    <span class="db4-brand-mark" aria-hidden="true"><i class="fas fa-store"></i></span>
                    <div class="min-w-0">
                        <div class="db4-brand-title"><?php echo e(config('app.name')); ?></div>
            ...
            <div class="db4-user">
                ...
                ?>
                <div class="db4-avatar" aria-hidden="true"><?php echo e(mb_substr($userName ?: 'U', 0, 1)); ?></div>
                <div class="min-w-0">
                    <div class="db4-user-name"><?php echo e($userName); ?></div>
                    <div class="db4-user-email"><?php echo $__env->yieldContent('user-role', 'مستخدم'); ?></div>
                </div>
                ...
                <div class="db4-topbar-inner">
                    <div class="min-w-0">
                        <div class="flex items-start gap-3">
                            <div class="min-w-0">
                                <h1 class="db4-title"><?php echo $__env->yieldContent('page-title', 'لوحة التحكم'); ?></h1>
                                <?php if (! empty(trim($__env->yieldContent('breadcrumb')))): ?>
                                    <div class="db4-subtitle"><?php echo $__env->yieldContent('breadcrumb'); ?></div>
                                <?php else: ?>
                                    <div class="db4-subtitle"><?php echo $__env->yieldContent('page-subtitle', ' '); ?> </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH E:\Tulip-Store\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>