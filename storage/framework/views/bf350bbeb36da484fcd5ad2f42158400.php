...
<script>
(function () {
  const USD_TO_SYP = Number(<?php echo json_encode((float) \App\Models\SystemSetting::get('usd_to_syp_rate', 117), 512) ?>) || 117;
  const serverCurrency = <?php echo json_encode(auth()->check() ? (strtoupper((string) (auth()->user()->currency ?: 'SYP'))) : (strtoupper((string) (session('currency') ?: 'SYP'))), 15, 512) ?>;
...
<?php /**PATH E:\Tulip-Store\resources\views/components/navbar.blade.php ENDPATH**/ ?>