                            ...
                            <?php $__currentLoopData = $customAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="attr-field" style="display:flex; flex-direction:column; gap:0.45rem;">
                                    ...
                                    <?php elseif($type === 'date'): ?>
                                        <input id="<?php echo e($fieldId); ?>" type="date" value="<?php echo e($attr->value); ?>" style="width:100%; height:55px; padding:0 1rem; border-radius:14px; border:2px solid #e5e7eb; background:#fff;" aria-label="<?php echo e($attr->name); ?>" min="1000-01-01" max="9999-12-31" oninput="if(this.value.length > 10) this.value=this.value.slice(0,10)">
        ...
        <div class="related-products-section">
            ...
            <div class="products-grid">
                <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <div class="product-card" data-product-id="<?php echo e($rp->id); ?>" onclick="window.location.href='/products/<?php echo e($rp->id); ?>'">
                        <button class="product-favorite-btn" onclick="event.stopPropagation(); toggleProductFavorite(event, <?php echo e($rp->id); ?>, this)">
                            <i class="far fa-heart"></i>
                        </button>
                        <div class="product-image-wrapper">
                            <img src="<?php echo e($rp->primary_image_url); ?>" srcset="<?php echo e($rp->primary_image_srcset); ?>" sizes="(max-width: 768px) 50vw, 20vw" alt="<?php echo e($rp->name); ?>" class="product-img" loading="lazy" width="320" height="320" onerror="this.src='/images/tulip_store.jpg'">
                        </div>
                        <div class="product-info-box">
                            ...
                            <div class="product-footer">
                                ...
                                <button type="button" class="add-cart-btn-small" onclick="event.stopPropagation(); addToCartFromList(<?php echo e($rp->id); ?>, this)" data-product-id="<?php echo e($rp->id); ?>" <?php echo e($isOutOfStock ? 'disabled' : ''); ?> style="<?php echo e($isOutOfStock ? 'opacity: 0.5; cursor: not-allowed;' : ''); ?>">
...
<?php /**PATH E:\Tulip-Store\resources\views/products/show.blade.php ENDPATH**/ ?>