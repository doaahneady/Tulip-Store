                ...
                <div class="flex h-16 justify-between items-center">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="text-sm text-gray-600">
                            Welcome, <span class="font-semibold text-gray-900"><?php echo e($employee->full_name); ?></span>
                        </div>
                        <form action="<?php echo e(route('employee.logout')); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
                            ...
                            <a href="<?php echo e(route($dashboard['route'])); ?>" 
                               class="group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-200 overflow-hidden">
                                ...
                                <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r 
                                    <?php if($dashboard['color'] === 'purple'): ?> from-purple-500 to-purple-600
                                    <?php elseif($dashboard['color'] === 'blue'): ?> from-blue-500 to-blue-600
                                    <?php elseif($dashboard['color'] === 'green'): ?> from-green-500 to-green-600
                                    <?php elseif($dashboard['color'] === 'emerald'): ?> from-emerald-500 to-emerald-600
                                    <?php elseif($dashboard['color'] === 'orange'): ?> from-orange-500 to-orange-600
                                    <?php elseif($dashboard['color'] === 'indigo'): ?> from-indigo-500 to-indigo-600
                                    <?php else: ?> from-gray-500 to-gray-600
                                    <?php endif; ?>"></div>
                                
                                <div class="p-8">
                                    <!-- Icon -->
                                    <div class="flex items-center justify-center w-16 h-16 mx-auto mb-6 rounded-2xl
                                        <?php if($dashboard['color'] === 'purple'): ?> bg-purple-100 text-purple-600
                                        <?php elseif($dashboard['color'] === 'blue'): ?> bg-blue-100 text-blue-600
                                        <?php elseif($dashboard['color'] === 'green'): ?> bg-green-100 text-green-600
                                        <?php elseif($dashboard['color'] === 'emerald'): ?> bg-emerald-100 text-emerald-600
                                        <?php elseif($dashboard['color'] === 'orange'): ?> bg-orange-100 text-orange-600
                                        <?php elseif($dashboard['color'] === 'indigo'): ?> bg-indigo-100 text-indigo-600
                                        <?php else: ?> bg-gray-100 text-gray-600
                                        <?php endif; ?>
                                        group-hover:scale-110 transition-transform duration-300">
                                        <i class="fas <?php echo e($dashboard['icon']); ?> text-2xl"></i>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-gray-600 text-sm leading-relaxed">
                                            <?php echo e($dashboard['description']); ?>
                ...
                <div class="mt-16 bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-2xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span class="font-medium text-gray-900 ml-2"><?php echo e($employee->employee_code); ?></span>
                        </div>
                        <div>
                            <span class="text-gray-600">Department:</span>
                            <span class="font-medium text-gray-900 ml-2"><?php echo e($employee->department ?? 'Not assigned'); ?></span>
                        </div>
                        <div>
                            <span class="text-gray-600">Position:</span>
                            <span class="font-medium text-gray-900 ml-2"><?php echo e($employee->position ?? 'Not assigned'); ?></span>
                        </div>
                        <div>
...
<?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/auth/employee-dashboard-selection.blade.php ENDPATH**/ ?>