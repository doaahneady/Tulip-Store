...
<?php $title = 'Style Guide'; $subtitle = 'Dashboard Next UI: tokens, components, and usage'; ?>

<div class="mb-6 flex flex-wrap items-center gap-3">
    <a href="<?php echo e(route('dashboard.admin.prototypes.wireframes')); ?>" class="btn btn-secondary">
        Wireframes
    </a>
    <a href="<?php echo e(route('dashboard.admin.prototypes.mockups')); ?>" class="btn btn-primary">
        Mockups
    </a>
</div>
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/dashboards/super-admin/style-guide.blade.php ENDPATH**/ ?>