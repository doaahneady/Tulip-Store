...
<body>
    ...
    <div class="grid">
        <div class="card">
            <h3>Customer</h3>
            <div class="row"><span>Name</span><span><?php echo e($customer); ?></span></div>
            <div class="row"><span>Phone</span><span><?php echo e($order->phone ?? '-'); ?></span></div>
            <div class="row"><span>Email</span><span><?php echo e($order->user?->email ?? '-'); ?></span></div>
        </div>
        <div class="card">
            <h3>Delivery</h3>
            <div class="row"><span>Delivery type</span><span><?php echo e($order->delivery_method ?? '-'); ?></span></div>
            <div class="row"><span>Estimated delivery</span><span><?php echo e($order->estimated_delivery ? \Carbon\Carbon::parse($order->estimated_delivery)->format('Y-m-d') : '-'); ?></span></div>
            <div class="row"><span>Address</span><span><?php echo e($order->village ?? '-'); ?> <?php echo e($order->address_note ? ' - '.$order->address_note : ''); ?></span></div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <tr>
                    <td><?php echo e($item->product->name ?? $item->product_name ?? ('Product #'.$item->product_id)); ?></td>
                    <td><?php echo e((int) ($item->quantity ?? 0)); ?></td>
                    <td class="right">$<?php echo e(number_format($unit, 2)); ?></td>
                    <td class="right">$<?php echo e(number_format($line, 2)); ?></td>
                </tr>
    ...
    <div class="totals">
        <div class="row"><span>Subtotal</span><span>$<?php echo e(number_format($subtotal, 2)); ?></span></div>
        <div class="row"><span>Delivery fee</span><span>$<?php echo e(number_format($delivery, 2)); ?></span></div>
        <div class="row"><span>Payment method</span><span><?php echo e($payMethod === 'payroll' ? 'Payroll' : ucfirst($payMethod)); ?></span></div>
        <div class="row" style="border-top:1px solid #e5e7eb; padding-top:10px; margin-top:10px;">
            <span><strong>Grand total</strong></span>
            <span><strong>$<?php echo e(number_format($total, 2)); ?></strong></span>
        </div>
    </div>
...
<?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/invoices/template-en.blade.php ENDPATH**/ ?>