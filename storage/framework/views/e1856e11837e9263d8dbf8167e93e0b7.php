...
<div id="createCategoryModal" class="fixed inset-0 bg-black/40 z-50 hidden">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl mx-auto mt-16">
        ...
        <form method="POST" action="<?php echo e(route('dashboard.admin.categories.create')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <?php endif; ?>
                <?php if(\Illuminate\Support\Facades\Schema::hasColumn('categories', 'image')): ?>
                    <div class="md:col-span-2">
...
<div id="editCategoryModal-<?php echo e($category->id); ?>" class="fixed inset-0 bg-black/40 z-50 hidden">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl mx-auto mt-16">
        ...
        <form method="POST" action="<?php echo e(route('dashboard.admin.categories.update', $category)); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboards.layouts.app', ['title' => 'التصنيفات', 'subtitle' => 'إضافة وتعديل وحذف التصنيفات'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Tulip-Store\resources\views/dashboards/super-admin/categories.blade.php ENDPATH**/ ?>