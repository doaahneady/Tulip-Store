            ...
            <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="px-4 py-3 text-right">
                        <a href="<?php echo e(route('dashboard.supervisor.drivers.edit', $driver)); ?>" class="text-sm text-indigo-600 hover:text-indigo-900 mr-2">تعديل</a>
                        <form method="POST" action="<?php echo e(route('dashboard.supervisor.drivers.update-status', $driver)); ?>" class="flex items-center gap-2">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboards.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Doaa\StudioProjects\Tulip-Store\resources\views/dashboards/supervisor/drivers.blade.php ENDPATH**/ ?>