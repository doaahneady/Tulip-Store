...
Route::prefix('admin/mart')->name('admin.mart.')->middleware('dashboard.role:mart,admin')->group(function () {
    ...
    Route::post('/categories/reorder', [SuperAdminController::class, 'reorderMartCategories'])->name('categories.reorder');
    Route::post('/categories/{category}/subcategories/reorder', [SuperAdminController::class, 'reorderMartSubcategories'])->name('subcategories.reorder');
    Route::get('/subcategories/create', [SuperAdminController::class, 'createMartSubcategory'])->name('subcategories.create');
    Route::post('/subcategories', [SuperAdminController::class, 'storeMartSubcategory'])->name('subcategories.store');
    Route::get('/subcategories/{subcategory}/edit', [SuperAdminController::class, 'editMartSubcategory'])->name('subcategories.edit');
    Route::put('/subcategories/{subcategory}', [SuperAdminController::class, 'updateMartSubcategory'])->name('subcategories.update');
    Route::delete('/subcategories/{subcategory}', [SuperAdminController::class, 'deleteMartSubcategory'])->name('subcategories.delete');
