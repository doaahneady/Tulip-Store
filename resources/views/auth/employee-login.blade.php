        ...
        <div class="form-side">
            <div class="form-container">
                ...
                <div class="login-form">
                    ...
                    <form action="{{ route('employee.login') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" id="email" name="email" value="{{ old('email') }}" required placeholder="name@company.com أو driver_username">
                    ...
                    <div class="alt-links">
                        @auth('employee')
                            @if(auth('employee')->user()->is_admin)
                                <a href="{{ route('dashboard.admin.downloads') }}" class="alt-link" style="border-color: #0D464C; color: #0D464C;">
