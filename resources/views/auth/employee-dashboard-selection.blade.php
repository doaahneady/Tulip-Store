                               ...
                               class="group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-200 overflow-hidden">
                                ...
                                <div class="p-8">
                                    ...
                                    <div class="text-center">
                                        <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-{{ $dashboard['color'] }}-600 transition-colors">
                                            {{ $dashboard['name'] }}
                                        </h3>
                                    ...
                                    <div class="flex justify-center mt-6">
                                        <div class="flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 group-hover:bg-{{ $dashboard['color'] }}-100 transition-colors">
                                            <i class="fas fa-arrow-right text-gray-400 group-hover:text-{{ $dashboard['color'] }}-600 transition-colors"></i>
                                        </div>
                                    </div>
                                </div>
                            </a>
