    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['total_orders'] ?? 0) }}</h3>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['monthly_orders'] ?? 0) }}</h3>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['pending_orders'] ?? 0) }}</h3>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['completed_orders'] ?? 0) }}</h3>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['total_revenue'] ?? 0, 2) }} ر.س</h3>
            </div>
            <div class="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['monthly_revenue'] ?? 0, 2) }} ر.س</h3>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['available_balance'] ?? 0, 2) }} ر.س</h3>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['pending_payout'] ?? 0, 2) }} ر.س</h3>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['total_products'] ?? 0) }}</h3>
            </div>
            <div class="w-12 h-12 bg-purple-100 rounded-2xl flex items-center justify-center">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['active_products'] ?? 0) }}</h3>
            </div>
            <div class="w-12 h-12 bg-teal-100 rounded-2xl flex items-center justify-center">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['low_stock_products'] ?? 0) }}</h3>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ number_format($metrics['out_of_stock_products'] ?? 0) }}</h3>
            </div>
            <div class="w-12 h-12 bg-amber-100 rounded-2xl flex items-center justify-center">
