@extends('dashboards.layouts.app', ['title' => 'Gifts Creation Stuff', 'subtitle' => 'إضافة الصناديق والزهور والتغليف والبطاقات والهدايا الجاهزة'])

@section('content')
<div class="mb-6 flex flex-wrap items-center gap-2">
    <a href="{{ route('dashboard.admin.gifts') }}" class="btn btn-secondary"><i class="fas fa-arrow-right"></i> رجوع لإدارة الهدايا</a>
</div>
