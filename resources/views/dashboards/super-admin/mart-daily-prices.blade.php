@extends('dashboards.layouts.app', ['title' => 'أسعار يومية', 'subtitle' => 'إدارة أسعار كل منتجات المارت'])

@section('content')
<div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
    <form method="POST" action="{{ route('dashboard.admin.mart.daily-prices.save') }}" class="space-y-6" id="dailyForm">
        @csrf
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('mart.daily-prices') }}" class="btn btn-secondary" target="_blank">عرض صفحة الأسعار</a>
