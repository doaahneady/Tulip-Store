...
@php
    $title = 'طلبات المارت';
    $subtitle = 'عرض كل طلب يحتوي على عنصر واحد على الأقل من المارت';
@endphp

<div class="mb-6 flex flex-wrap items-center justify-between gap-3">
    <div class="flex flex-wrap items-center gap-2">
        <a href="{{ route('dashboard.admin.mart.index') }}" class="inline-flex items-center gap-2 bg-gray-100 text-gray-700 px-4 py-2 rounded-xl hover:bg-gray-200 transition">
            <i class="fas fa-arrow-right"></i>
            <span>لوحة المارت</span>
        </a>
    </div>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100">
    <div class="p-6 border-b border-gray-100">
        <form method="GET" action="{{ route('dashboard.admin.mart.orders.index') }}" class="grid grid-cols-1 md:grid-cols-6 gap-3">
            ...
            <div class="md:col-span-6 flex items-center gap-2">
                ...
                <a href="{{ route('dashboard.admin.mart.orders.index') }}" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200">إعادة ضبط</a>
            </div>
        </form>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($orders as $order)
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('dashboard.admin.mart.orders.show', $order) }}" class="px-3 py-1.5 rounded-lg bg-white border border-gray-200 text-sm text-gray-700 hover:bg-gray-100">عرض</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
