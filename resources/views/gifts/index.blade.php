    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .coming-soon-card {
            ...
            /* max-width: 1200px; */
            width: 100%;
            border: 1px solid rgba(26, 90, 90, 0.05);
            position: relative;
            overflow: hidden;
        }
        .coming-soon-card::before {
            ...
            right: 0;
            height: 6px;
            background: linear-gradient(90deg, #1a5a5a, #3d9a8a);
        }
        .coming-soon-icon {
            font-size: 5rem;
            color: #1a5a5a;
        ...
        .back-home-btn {
            ...
            font-size: 1.1rem;
            transition: all 0.3s;
            box-shadow: 0 10px 25px rgba(26, 90, 90, 0.2);
        }
        .back-home-btn:hover {
            transform: translateY(-3px);
            box-shadow: 0 15px 35px rgba(26, 90, 90, 0.3);
            background: linear-gradient(135deg, #2d7a7a, #3d9a8a);
        }
        .back-home-btn i {
...
<body>
    ...
    <div class="coming-soon-container">
        <div class="coming-soon-card">
            ...
            <h1 class="coming-soon-title">قريباً جداً</h1>
            <p class="coming-soon-text">
                نحن نعمل بجد لتجهيز باقة مميزة من الهدايا التي تليق بمناسباتكم السعيدة. 
                <br>انتظرونا قريباً في حلّة جديدة كلياً!
            </p>
